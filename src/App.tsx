...
function App() {
  ...
  const handleLinkClick = (sectionId: string) => {
    ...
    if (section && container) {
      let sectionTop = section.offsetTop - container.offsetTop; // Relative to container
      if (section.id == "about_section")
        sectionTop = section.offsetTop - container.offsetTop - 200;
